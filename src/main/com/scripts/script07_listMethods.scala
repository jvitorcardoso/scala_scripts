...
object listMethods:
  ...
  @main def m(): Unit =
    ...
    val int_01_with_element_2_of_list_4: Int = list_04_with_concat_int(2)
    println(s"\t- Integer 1: Element at index 2 of list_04: $int_01_with_element_2_of_list_4\n")
    // 3
    
    val int_02_count_elements_in_list_5_that_have_lenght_4: Int = list_05_with_new_concat_str.count(book => book.length == 4)
    println(s"\t- Integer 2: How many books has four letters? $int_02_count_elements_in_list_5_that_have_lenght_4\n")
    // 4
